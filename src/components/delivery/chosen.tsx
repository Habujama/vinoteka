  ...
  <div className="flex flex-col justify-center px-4 mx-auto mb-4 max-w-70 text-center align-center">
    ...
    <div className="flex justify-center">
      <a
        ...
        className="inline-block justify-self-center font-bold text-xl text-center text-white bg-black transform hover:scale-125 py-2 px-6 mt-8 rounded-md shadow-md ease-in-out duration-200"
      >
